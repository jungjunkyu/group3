			...
			<div class="row gx-4 gx-lg-5 align-items-center">
				<div class="col-md-6">
					<img class="card-img-top mb-5 mb-md-0"
						src="https://image.msscdn.net/images/goods_img/20170905/624932/624932_2_500.jpg"
						alt="..." />
				</div>
				<div class="col-md-6">
					...
					<div class="fs-5 mb-5">
						<span class="text-decoration-line-through">81,000원</span> <span>→
							${board.bo_price}원</span>
					</div>
